...
1. [Node.js][]: We use Node to run a development web server and build the project.
   Depending on your system, you can install Node either from source or as a pre-packaged bundle. Use LTS version.
2. [Yarn][]: We use Yarn to manage Node dependencies.
   Depending on your system, you can install Yarn either from source or as a pre-packaged bundle.
3. [Bower][]: From web packages.  
4. [Gulp][]: From build scrips.
5. [Maven](https://maven.apache.org/): From Java packages.
...
Database from development is H2.


## Building for production

Database from production is Mysql.
To optimize the taskstp application for production, run:

    ./mvnw -Pprod clean package or mvn Pprod clean package
...
To achieve this, first build a docker image of your app by running:
    ...
    ./mvnw package -Pprod docker:build or mvn package -Pprod docker:build
...
Then navigate to [http://0.0.0.0:8080/#/](http://0.0.0.0:8080/#/) in your browser.
