(function() {
    ...
    TarefaDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Tarefa', 'User'];

    function TarefaDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Tarefa, User) {
        var vm = this;
        ...
        function save () {
            ...
            if (vm.tarefa.id !== null) {
                ...
                vm.tarefa.dataCriacao = new Date();
